...
using WebMvcCourse.Models.Enums;

namespace WebMvcCourse.Data
{
    public class SeedingService
    {
        private WebMvcCourseContext _context;

        public SeedingService(WebMvcCourseContext context)
        {
        ...
        public void Seed()
        {
            // Nao popula o banco caso ja tenha algum registro
